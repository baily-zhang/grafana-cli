...
func discoveryCatalog() []discoveryCommand {
	return []discoveryCommand{
		...
		},
		{
			...
			ReadOnly:    false,
			Subcommands: []discoveryCommand{
				{Name: "list", Description: "Search dashboards by query, tag, or folder", ReadOnly: true, Flags: []discoveryFlag{{Name: "--query", Type: "string", Description: "Search text"}, {Name: "--tag", Type: "string", Description: "Tag filter"}, {Name: "--folder-uid", Type: "string", Description: "Folder UID filter"}, {Name: "--limit", Type: "int", Default: 100, Description: "Maximum dashboards"}}, Examples: []string{"grafana dashboards list --query latency --tag prod", "grafana dashboards list --folder-uid ops"}, OutputShape: `[{"uid":"incident-overview"}]`, RelatedCommands: []string{"dashboards get", "dashboards versions", "folders list"}, TokenCost: "small"},
		...
		},
		{
			...
			Subcommands: []discoveryCommand{
				...
				{Name: "wait", Description: "Wait for Assistant chat completion", ReadOnly: true, Flags: []discoveryFlag{{Name: "--chat-id", Type: "string", Description: "Chat ID"}, {Name: "--interval", Type: "duration", Default: "2s", Description: "Polling interval"}, {Name: "--timeout", Type: "duration", Default: "30s", Description: "Maximum wait time"}}, Examples: []string{"grafana assistant wait --chat-id chat_123", "grafana assistant wait --chat-id chat_123 --timeout 60s"}, OutputShape: `{"status":"completed"}`, RelatedCommands: []string{"assistant chat", "assistant status"}, TokenCost: "small"},
